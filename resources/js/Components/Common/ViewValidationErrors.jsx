// バリデーションエラーを一元化表示
export default function ViewValidationErrors({errors,mt="",minWidth="",maxWidth="", validationHidden=false}){
  ...
  return(
    <div className={`${validationHidden ? "hidden" : ""} base_frame mb-6 ${mt} ${minWidth} ${maxWidth}`}>
