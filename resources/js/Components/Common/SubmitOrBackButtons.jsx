...
export default function SubmitOrBackButtons({minWidth="min-w-75", maxWidth="max-w-250",processing,errors={},onSubmitBtnClick,onCancelBtnClick,disabled=false,cancelSentence="やり直す"}){
  return(
    ...
    <button type="button" onClick={onSubmitBtnClick} className={`base_btn ${processing || Object.keys(errors).length>0  ? "non_active_btn" :"active_btn"} inline-block`} disabled={disabled}>決定！</button>
