...
class ProjectHelpers{
    ...
    // 更新するか作成するかの選択
    public static function need_user_confirm($project_name,$date_town_sets,$latest_another_project_flag_id){
            // 同じプロジェクトで1月以上の期間が開いているものがあるかの取得
            // 前回のプロジェクト終了から、今回のプロジェクト開始が、１ヶ月より長いものがあれば、まずは確認後、処理を決定
            if(Project::where([
                ["project_name",$project_name],
                ["another_project_flag",$latest_another_project_flag_id],
